...
import menuIcon from '/Fullstack Project/HabitFlow/ClientSide/src/assets/menu.svg'
import crossIcon from "/Fullstack Project/HabitFlow/ClientSide/src/assets/cross.svg";
      ...
      <nav className="hidden md:flex flex-row gap-8 text-lg font-medium items-center">
        {links.map((label) => (
          <button
            ...
            md:text-black md:hover:text-red-400 hover:opacity-100 md:hover:bg-white relative
